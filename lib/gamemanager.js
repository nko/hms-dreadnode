...
GameManager.prototype.addUser = function(user, ioSessionId) {
  ...
  var newPlaya = new Playa(existingGame, user);
  existingGame.addPlayer(newPlaya);
  this.connections[ioSessionId] = newPlaya;
  // this.emit("newuser");
